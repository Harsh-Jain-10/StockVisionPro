...
@router.get("/screener")
def run_ai_screener(q: str | None = None, db: Session = Depends(get_db)) -> dict:
    """Fetch and analyze stocks (matching q or NSE universe) for bullish candidates."""
    return ai_screener(db, q)
